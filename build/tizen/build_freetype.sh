...
cp $top_dir/contrib/arm-linux-gnueabi-armv7a/lib/libfreetype.a $library_name/prebuilt/tizen/arm/
cp -r $top_dir/contrib/arm-linux-gnueabi-armv7a/include/$library_name  $library_name/include/tizen/
